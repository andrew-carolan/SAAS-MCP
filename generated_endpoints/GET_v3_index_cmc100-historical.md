...
**Summary:** CoinMarketCap 100 Index Historical
...
- **time_start** (query) - *Optional*: Timestamp (Unix or ISO 8601) to start returning CoinMarketCap 100 Index data for. Optional, if not passed, we'll return quotes calculated in reverse from "time_end".
- **time_end** (query) - *Optional*: Timestamp (Unix or ISO 8601) to stop returning CoinMarketCap 100 Index data for (inclusive). Optional, if not passed, we'll default to the current time. If no "time_start" is passed, we return quotes in reverse order starting from this time.
...
```json
{
  "slug": "coinmarketcap-100-index-historical",
  "summary": "CoinMarketCap 100 Index Historical",
  "method": "get",
  "description": "Returns an interval of historic CoinMarketCap 100 Index values based on the interval parameter. \t\t\n\n\n \n **This endpoint is available on the following [API plans](https://coinmarketcap.com/api/pricing/):**\n - Basic\n - Startup\n - Hobbyist\n - Standard\n - Professional\n - Enterprise\n\n**Cache / Update frequency:** Every 5 minutes.     \n**Plan credit use:** 1 API call credit per request no matter query size.     \n**CMC equivalent pages:** Our CoinMarketCap 100 Index on https://coinmarketcap.com/charts/cmc100/.",
  "operationId": "getV3IndexCMC100Historical",
  "contentTypes": [],
      ...
      "content": [
        {
          ...
          "schema": {
              ...
              "data": {
                "items": {
                  "properties": {
                    ...
                    "value": {
                      "description": "Value of CoinMarketCap 100 Index.",
                      "format": "bigdecimal",
                      "type": "number"
                    }
                  },
                  "type": "object",
                  "__$ref": "#/components/schemas/IndexHistoricalDTO"
                },
                "type": "array",
                "__$ref": "#/components/schemas/IndexHistoricalDpsDTO"
              },
              "status": {
                "properties": {
                  "credit_count": {
            ...
            "type": "object",
            "__$ref": "#/components/schemas/ApiResponseOfIndexHistoricalResponseDTO"
          }
        }
      ]
    },
