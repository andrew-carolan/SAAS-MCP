...
- **id** (query) - *Required*: The Category ID. This can be found using the Categories API.
- **start** (query) - *Optional*: Optionally offset the start (1-based index) of the paginated list of coins to return.
- **limit** (query) - *Optional*: Optionally specify the number of coins to return. Use this parameter and the "start" parameter to determine your own pagination size.
      ...
      "content": [
        {
          ...
          "schema": {
                ...
                "additionalProperties": {
                  ...
                  "properties": {
                    ...
                    "coins": {
                      ...
                      "__$ref": "#/components/schemas/Cryptocurrency_-_Results_array"
                    },
                    "last_updated": {
                      "type": "string",
                      "format": "yyyy-MM-dd'T'HH:mm:ss.SSSZ",
                  ...
                  "__$ref": "#/components/schemas/Category_-_Cryptocurrency_object"
                },
                "__$ref": "#/components/schemas/Category_-_Results_map"
              },
              "status": {
                "type": "object",
            ...
            "__$ref": "#/components/schemas/Category_-_Response_Model"
          }
        }
      ]
    },
