...
- **sort** (query) - *Optional*: What field to sort the list by.
- **include_metals** (query) - *Optional*: Pass `true` to include precious metals.
      ...
      "content": [
        {
          ...
          "schema": {
            ...
            "properties": {
              "data": {
                ...
                "items": {
                  ...
                  "__$ref": "#/components/schemas/Fiat_Map_-_Fiat_Object"
                },
                "__$ref": "#/components/schemas/Fiat_Map_-_Fiat_Array"
              },
              "status": {
                "type": "object",
            ...
            "__$ref": "#/components/schemas/Fiat_Map_-_Response_Model"
          }
        }
      ]
    },
