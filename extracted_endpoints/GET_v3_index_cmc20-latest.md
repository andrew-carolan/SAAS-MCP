...
**Summary:** CoinMarketCap 20 Index Latest

**Description:** Returns the lastest CoinMarketCap 20 Index value, constituents, and constituent weights. 		
...
```json
{
  "slug": "coinmarketcap-20-index-latest",
  "summary": "CoinMarketCap 20 Index Latest",
  "method": "get",
  "description": "Returns the lastest CoinMarketCap 20 Index value, constituents, and constituent weights. \t\t\n\n\n \n **This endpoint is available on the following [API plans](https://coinmarketcap.com/api/pricing/):**\n - Basic\n - Startup\n - Hobbyist\n - Standard\n - Professional\n - Enterprise\n\n**Cache / Update frequency:** Every 5 minutes.     \n**Plan credit use:** 1 call credit per API call.     \n**CMC equivalent pages:** Our CoinMarketCap 20 Index on https://coinmarketcap.com/charts/cmc20/.",
  "operationId": "getV3IndexCMC20Latest",
  "contentTypes": [],
  "path": "/v3/index/cmc20-latest",
  "deprecated": null,
  "extensions": {},
  "servers": [
    {
      ...
      "content": [
        {
          ...
          "schema": {
            "properties": {
              "data": {
                "description": "The latest CoinMarketCap 20 Index value is returned in this object.",
                "properties": {
                  "constituents": {
                  ...
                  "value": {
                    "description": "Current value of CoinMarketCap 20 Index.",
                    "format": "bigdecimal",
                    "type": "number"
                  },
                  "value_24h_percentage_change": {
                    "description": "Percentage change of the CoinMarketCap 20 Index over the past 24h. ",
                    "format": "bigdecimal",
                    "type": "number"
                  }
                },
                "type": "object",
                "__$ref": "#/components/schemas/CMC20IndexLatestDTO"
              },
              "status": {
                "properties": {
                  "credit_count": {
            ...
            "type": "object",
            "__$ref": "#/components/schemas/ApiResponseOfCMC20IndexLatestResponseDTO"
          }
        }
      ]
    },
