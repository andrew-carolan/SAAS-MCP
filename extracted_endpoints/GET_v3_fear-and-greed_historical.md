...
**Description:** Returns a paginated list of all CMC Crypto Fear and Greed values at 12am UTC time. 			
...
```json
{
  "slug": "cmc-crypto-fear-and-greed-historical",
  "summary": "CMC Crypto Fear and Greed Historical",
  "method": "get",
  "description": "Returns a paginated list of all CMC Crypto Fear and Greed values at 12am UTC time. \t\t\t\n\n\n \n  **This endpoint is available on the following [API plans](https://coinmarketcap.com/api/pricing/):**\n  - Basic\n  - Startup\n  - Hobbyist\n  - Standard\n  - Professional\n  - Enterprise\n\n**Cache / Update frequency:** Every 15 seconds.  \n**Plan credit use:** 1 API call credit per request no matter query size.   \n**CMC equivalent pages:** Our CMC Crypto Fear and Greed Index card on https://coinmarketcap.com/charts/.",
  "operationId": "getV3FearandgreedHistorical",
  "contentTypes": [],
      ...
      "content": [
        {
          ...
          "schema": {
            ...
            "properties": {
              "data": {
                "type": "array",
                "description": "Fear and Greed Historical.",
                "example": [
                  {
                ...
                "items": {
                  ...
                  "__$ref": "#/components/schemas/Fear_and_Greed_Historical_-_Fear_and_Greed_object"
                },
                "required": [
                  "Fear and Greed Historical - Fear and Greed object"
                ],
                "__$ref": "#/components/schemas/Fear_and_Greed_Historical_-_Results_map"
              },
              "status": {
                "type": "object",
            ...
            "__$ref": "#/components/schemas/Fear_and_Greed_Historical_-_Response_Model"
          }
        }
      ]
    },
