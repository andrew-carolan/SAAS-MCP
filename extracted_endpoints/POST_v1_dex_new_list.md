...
**Description:** Get list of newly launched tokens
      ...
      "content": [
        {
          ...
          "schema": {
            ...
            "properties": {
              ...
              "nextPageIndex": {
                "type": "string",
                "description": "Index to be used for the next page request, if hasNextPage is true"
              }
            },
            "description": "NewTokenLeaderboard response object",
            "__$ref": "#/components/schemas/NewTokenLeaderBoardResponseDTO"
          }
        }
      ]
    }
