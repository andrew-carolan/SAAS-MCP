...
- **self_reported_circulating_supply_min** (query) - *Optional*: Optionally specify a threshold of minimum self reported circulating supply to filter results by.
- **self_reported_circulating_supply_max** (query) - *Optional*: Optionally specify a threshold of maximum self reported circulating supply to filter results by.
- **self_reported_market_cap_min** (query) - *Optional*: Optionally specify a threshold of minimum self reported market cap to filter results by.
- **self_reported_market_cap_max** (query) - *Optional*: Optionally specify a threshold of maximum self reported market cap to filter results by.
- **unlocked_market_cap_min** (query) - *Optional*: Optionally specify a threshold of minimum unlocked market cap to filter results by.
- **unlocked_market_cap_max** (query) - *Optional*: Optionally specify a threshold of maximum unlocked market cap to filter results by.
- **unlocked_circulating_supply_min** (query) - *Optional*: Optionally specify a threshold of minimum unlocked circulating supply to filter results by.
- **unlocked_circulating_supply_max** (query) - *Optional*: Optionally specify a threshold of maximum unlocked circulating supply to filter results by.
...
```json
{
  ...
  "parameters": [
    ...
    {
      "name": "self_reported_circulating_supply_min",
      "in": "query",
    ...
    {
      "name": "self_reported_circulating_supply_max",
      "in": "query",
    ...
    {
      "name": "self_reported_market_cap_min",
      "in": "query",
    ...
    {
      "name": "self_reported_market_cap_max",
      "in": "query",
    ...
    {
      "name": "unlocked_circulating_supply_min",
      "in": "query",
    ...
    {
      "name": "unlocked_circulating_supply_max",
      "in": "query",
      ...
      "content": [
        {
          ...
          "schema": {
            ...
            "properties": {
              "data": {
                ...
                "items": {
                  ...
                  "properties": {
                    ...
                    "quote": {
                      ...
                      "additionalProperties": {
                        ...
                        "__$ref": "#/components/schemas/Cryptocurrency_Listings_Latest_-_Quote_object_1"
                      },
                      "__$ref": "#/components/schemas/Cryptocurrency_Listings_Latest_-_Quote_map_1"
                    }
                  },
                  "required": [
                    "id",
                  ...
                  "__$ref": "#/components/schemas/Cryptocurrency_Listings_Latest_-_Cryptocurrency_object_1"
                },
                "required": [
                  "Cryptocurrency Listings Latest - Cryptocurrency object"
                ],
                "__$ref": "#/components/schemas/Cryptocurrency_Listings_Latest_-_Results_array_1"
              },
              "status": {
                "type": "object",
            ...
            "__$ref": "#/components/schemas/Cryptocurrency_Listings_Latest_-_Response_Model_1"
          }
        }
      ]
    },
