...
- **time_period** (query) - *Optional*: Adjusts the overall window of time for most visited currencies.
          ...
          "schema": {
            ...
            "properties": {
              "data": {
                ...
                "__$ref": "#/components/schemas/Cryptocurrency_Trending_Most_Visited_-_Results_array"
              },
              "status": {
                "type": "object",
            ...
            "__$ref": "#/components/schemas/Cryptocurrency_Trending_Most_Visited_-_Response_Model"
          }
        }
      ]
    },
