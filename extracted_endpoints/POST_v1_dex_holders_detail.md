...
**Summary:** Get holder detail

**Description:** Get detailed information for holders detail
...
```json
{
  "slug": "get-holder-detail",
  "summary": "Get holder detail",
  "method": "post",
  "description": "Get detailed information for holders detail",
  "operationId": "getHolderDetail",
  "contentTypes": [
    "application/json"
  ],
  "path": "/v1/dex/holders/detail",
  "deprecated": null,
  "extensions": {},
  "servers": [
    {
    ...
    "content": [
      {
        ...
        "schema": {
          ...
          "description": "holders detail request",
          "__$ref": "#/components/schemas/DqueryHoldersDetailRequestDTO"
        }
      }
    ],
    "description": null,
