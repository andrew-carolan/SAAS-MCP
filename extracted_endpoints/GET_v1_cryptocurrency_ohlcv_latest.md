...
- **symbol** (query) - *Optional*: Alternatively pass one or more comma-separated cryptocurrency symbols. Example: "BTC,ETH". At least one "id" *or* "symbol" is required.
...
```json
{
  "slug": "ohlcv-latest-v1-deprecated",
  "summary": "OHLCV Latest v1 (deprecated)",
  "method": "get",
  "description": "Returns the latest OHLCV (Open, High, Low, Close, Volume) market values for one or more cryptocurrencies for the current UTC day. Since the current UTC day is still active these values are updated frequently. You can find the final calculated OHLCV values for the last completed UTC day along with all historic days using /cryptocurrency/ohlcv/historical. \n\n\n  **This endpoint is available on the following [API plans](https://coinmarketcap.com/api/pricing/):**\n  - ~~Basic~~\n  - ~~Hobbyist~~\n  - Startup\n  - Standard\n  - Professional\n  - Enterprise\n\n  **Cache / Update frequency:** Every 10 minutes. Additional OHLCV intervals and 1 minute updates will be available in the future.  \n  **Plan credit use:** 1 call credit per 100 OHLCV values returned (rounded up) and 1 call credit per `convert` option beyond the first.  \n  **CMC equivalent pages:** No equivalent, this data is only available via API.",
  "operationId": "getV1CryptocurrencyOhlcvLatest",
  "contentTypes": [],
  "path": "/v1/cryptocurrency/ohlcv/latest",
  "deprecated": null,
  "extensions": {},
  "servers": [
    {
      ...
      "content": [
        {
          ...
          "schema": {
            ...
            "properties": {
              "data": {
                ...
                "additionalProperties": {
                  ...
                  "properties": {
                    ...
                    "quote": {
                      ...
                      "additionalProperties": {
                        ...
                        "__$ref": "#/components/schemas/Cryptocurrency_OHLCV_Latest_-_Quote_object"
                      },
                      "__$ref": "#/components/schemas/Cryptocurrency_OHLCV_Latest_-_Quote_map"
                    }
                  },
                  "required": [
                    "id",
                  ...
                  "__$ref": "#/components/schemas/Cryptocurrency_OHLCV_Latest_-_Cryptocurrency_object"
                },
                "__$ref": "#/components/schemas/Cryptocurrency_OHLCV_Latest_-_Cryptocurrency_Results_map"
              },
              "status": {
                "type": "object",
            ...
            "__$ref": "#/components/schemas/Cryptocurrency_OHLCV_Latest_-_Response_Model"
          }
        }
      ]
    },
